/* ═══════════════════════════════════════════════════════════════
   SEMAILBOX.JS — SE Mailbox Intelligence v6.6
...
let MB = {
    ...
    dataLoaded:   false,
    lastFileName: mbSafeStorageGet('semailbox_last_file_name'),
};
...
async function mbSaveToSP(arrayBuffer, fileName) {
    try {
        ...
        mbSafeStorageSet(MB_CONFIG.STORAGE_KEY, fileName);
...
function mbInjectShell() {
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:.75rem;margin-bottom:1rem;">
        <div>
            ...
            <div style="font-size:.75rem;color:var(--t3);">Agent/Citrix assignment · Age &amp; filters based on received date</div>
        </div>
